	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">K S Rangasamy College Of Technology</a>
			</div>
	  			...
	  			<!-- <h1>Flickity - wrapAround</h1> -->
					...
					<div class="carousel" data-flickity='{ "autoPlay": true }'; >
						  ...
						  <div class="carousel-cell" auto-play >
						  	<img src="ify/header-bg.jpg">
						  </div>
						  <div class="carousel-cell" auto-play>
						  	<img src="ify/IT-park.jpg">

						  </div>
						  <div class="carousel-cell" auto-play>
						  	 <img src="ify/arts.jpg">
						  </div>
						  
						  <div class="carousel-cell" auto-play >
						  	<img src="ify/over.jpg">
						  </div>
						   <div class="carousel-cell" auto-play>
						  	<img src="ify/hall.jpg">
						  </div>
